...
import { regionHotels, regions } from '../../data/regions';
import HotelCard from './HotelCard';

// Barcha mehmonxonalarni birlashtirish
const allHotels = Object.entries(regionHotels || {}).flatMap(([regionId, hotels]) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <p className="text-white/70 font-body text-base max-w-lg mx-auto">
              Ozbekiston boylab eng yaxshi mehmonxonalarni toping va bron qiling
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <select
            ...
            className="px-4 py-2.5 rounded-xl border border-[var(--border-color)] bg-[var(--bg-card)] text-[var(--text-primary)] font-body text-sm focus:outline-none focus:border-gold-500"
          >
            <option value="rating">Reyting boyicha</option>
