        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            {[
              {
                icon: "🎯",
                title: "Missiyamiz",
                desc: "O&#39;zbekiston turizmini raqamlashtirish va dunyoga taqdim etish. Har bir sayyoh uchun mukammal sayohat tajribasini yaratish.",
              },
              {
                icon: "🌍",
                title: "Viziyamiz",
                desc: "O&#39;zbekistonni dunyo turizmidagi eng mashhur destinatsiyalardan biriga aylantirish va raqamli infratuzilmani rivojlantirish.",
              },
              {
                icon: "🤝",
                title: "Hamkorlik",
                desc: "Mehmonxonalar, restoran va turizm kompaniyalari bilan hamkorlik qilib, turistlarga eng yaxshi xizmatni taqdim etamiz.",
              },
              {
                icon: "🚀",
                title: "Texnologiya",
                desc: "AI, AR va zamonaviy web texnologiyalaridan foydalanib, yangi darajadagi turizm platformasini yaratdik.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl border border-[var(--border-color)] bg-[var(--bg-card)] hover:border-gold-500/30 transition-colors"
              >
          ...
          <div className="text-center rounded-2xl border border-gold-500/20 bg-gold-500/5 p-8">
            ...
            <p className="text-[var(--text-secondary)] font-body mb-4">
              info@uztour.uz | +998 71 234 56 78
            </p>
